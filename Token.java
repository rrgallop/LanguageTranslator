...
public class Token implements Comparable<Token>{
   ...
   public  static TreeSet<Integer> ifStListSet = new TreeSet<Integer>();    // for the true branch of an if
   public  static TreeSet<Integer> elseStListSet = new TreeSet<Integer>();    // for the false branch of an if
   public  static TreeSet<Integer> progStListSet = new TreeSet<Integer>();    // for the main program
   ...
   public  static TreeSet<Integer> asgnSet = new  TreeSet<Integer>();    // <asgn>, <set asgn> and <nat asgn> are the same

   public  static TreeSet<Integer> setAsgnSet = asgnSet;  // will be same as asgnSet;
   public  static TreeSet<Integer> natAsgnSet = asgnSet;  // will be same as asgnSet;
   ...
   public static TreeSet<Integer> setLevel2Set = setExpSet,
                                  setLevel1Set = setExpSet,
                                  setLevel0Set = setExpSet;
   ...
   public  static TreeSet<Integer> ifSet = new TreeSet<Integer>();  // for <if>, <if prefix> is the same
   public  static TreeSet<Integer> ifPrefixSet = ifSet;  // for <if prefix>; same as <if>
   ...
   static{
      ...
      progStListSet.add(Token.END);
      progStListSet.add(Token.IF);
      progStListSet.add(Token.ID);

      ifStListSet.add(Token.ID);
      ifStListSet.add(Token.IF);
      ifStListSet.add(Token.ELSE);
      ifStListSet.add(Token.ENDIF);

      elseStListSet.add(Token.ID);
      elseStListSet.add(Token.IF);
      elseStListSet.add(Token.ENDIF);
